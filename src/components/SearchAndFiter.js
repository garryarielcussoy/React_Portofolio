            ...
            <div className='row'>
                <div className='col-12 search-filter-area'>
                    ...
                    <form onSubmit={(e) => props.handleSubmit(e)}>
                        ...
                        <button type="submit" class="btn btn-primary search-button" onClick={() => props.handleSearch()}>Cari</button>
                    </form>
                    ...
                    <form className='input-user-form' onSubmit={(e) => props.handleSubmit(e)}>
                        ...
                        <button type='submit' className='btn btn-primary search-button' onClick={() => props.handleFilter()}>Cari</button>
                    </form>
                </div>
            </div>
        </div>
